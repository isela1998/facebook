        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    buttons += '<a href="#" rel="down" data-title="A Stock2" type="button" class="btn btn-warning btn-smp btn-flat"><i class="fas text-dark fa-arrow-down"></i></a> ';
...
$(function () {
    ...
    $('#data tbody').on('click', 'a[rel="edit"]', function () {
        ...
        .on('click', 'a[rel="view_product"]', function () {
            ...
            parameters.append('action', 'down-stock');
            parameters.append('id', data.id);
            submit_with_ajax_msj(window.location.pathname, 'Notificación', '¿Está seguro de bajar a Stock 2?', parameters, function () {
    ...
    $('.formProduct').on('submit', function (e) {
        ...
        submit_with_ajax(window.location.pathname, parameters, function () {
            ...
            alertSweetSuccess('Listado de Productosss actualizado');
