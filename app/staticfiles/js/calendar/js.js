...
function get_all_events() {
    tableEvents = $('#data').DataTable({
        ...
        fnDrawCallback: function () {
            ...
            $("input[type='search']").attr("placeholder", "Título/Descripción/Fecha...");
        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) {
                    let tr = '<td><b><i class="text-dark">' + row.name + '</i></b><br>' + row.description + '<br>' + row.day + '</td>';
                    return tr;
                }
            },
            {
                ...
                orderable: false,
                render: function (data, type, row) {
                    let buttons = '<a href="#" type="button" rel="delete" class="btn btn-danger btn-xs btn-flat btnDelete"><i class="fas fa-trash-alt"></i></a> ';
                    return buttons;
                }
            },
        ]
...
$(function () {
    ...
    $('#data tbody').on('click', 'a[rel="delete"]', function () {
        ...
        submit_with_ajax_msj(window.location.pathname, 'Notificación', '¿Está seguro de eliminar el siguiente Evento?', parameters, function () {
